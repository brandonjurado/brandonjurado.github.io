<h1 align="center">
  <a href="https://bjurado.com">Brandon's Portfolio</a>
</h1>
...
From your command line, clone and run brandonjurado.github.io:
...
- Navigate to `package.json` and enter your domain name instead of `https://bjurado.com/` in `homepage` variable. 
...
[![Deploy To Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/brandonjurado/brandonjurado.github.io)
